...
public:
	 ...
	 * angles in rad
	 */
	ViewVolume(double min_dist, double max_dist, double h_angle, double v_angle,
			const Eigen::Affine3f &sensor_pose, double tolerance) :
		min_dist(min_dist), max_dist(max_dist),
		max_sin_h_angle(sin(h_angle/2 - tolerance)),
		max_sin_v_angle(sin(v_angle/2 - tolerance)),
